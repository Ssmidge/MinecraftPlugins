...
public class HWIDProtection {
    ...
    public HWIDProtection(String licenseKey, String validationServer, Plugin plugin) {
        this.licenseKey = licenseKey;
        this.plugin = plugin;
        this.validationServer = validationServer;
    }

    public HWIDProtection setSecurityKey(String securityKey) {
        this.securityKey = securityKey;
        return this;
    }

    public HWIDProtection setConsoleLog(LogType logType) {
        this.logType = logType;
        return this;
    }

    public HWIDProtection debug() {
        debug = true;
        return this;
    }
